...
"\n"
"    mat3 inverseRotation = transpose(rotationMatrix); // Fast inverse for orthonormal mat3\n"
"    vec3 voxelLocalPos = inverseRotation * (worldPos - position); // Transform to local space\n"
"    \n"
"    if (all(greaterThanEqual(voxelLocalPos, -halfSize)) &&\n"
"        all(lessThanEqual(voxelLocalPos,  halfSize))) {\n"
"        \n"
"        uint index = getIndex(localPos) + \n"
"                     (VoxelCountPerChunk.x * VoxelCountPerChunk.y * VoxelCountPerChunk.z * chunkIdx);\n"
"    \n"
"        voxels[index] = (delete)\n"
"            ? packRGBA(vec4(0.0))\n"
