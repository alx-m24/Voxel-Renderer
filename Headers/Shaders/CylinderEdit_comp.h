...
"uniform vec3 size;\n"
"uniform float radius;      // Outer radius of the cylinder\n"
"uniform float thickness;   // Thickness of the cylinder wall (optional)\n"
"\n"
...
"\n"
"    // Out of bounds check\n"
"    if (any(greaterThanEqual(localPos, VoxelCountPerChunk)) || any(lessThan(localPos, ivec3(0)))) return;\n"
"\n"
...
"    vec3 voxelLocalPos = inverseRotation * (worldPos - position);\n"
"    \n"
"    float innerRadius = radius - thickness;\n"
"    bool insideHeight = (voxelLocalPos.y >= -size.y * 0.5) && (voxelLocalPos.y <= size.y * 0.5);\n"
"    float distFromCenter = length(voxelLocalPos.xz);\n"
"    bool insideRadius = (distFromCenter >= innerRadius) && (distFromCenter <= radius);\n"
"    \n"
...
"        voxels[index] = (delete)\n"
"            ? packRGBA(vec4(0.0))\n"
"            : packRGBA(getColor(color, worldPos, randomizeColor));\n"
"    }\n"
"}\n"
;
